...
class DrushStack extends CommandStack
{
    ...
    public function clearCache($name = 'all')
    {
        ...
        return $this->drush('cache:clear ' . $name);
    }
     ...
     * @return $this
     */
    public function revertAllFeatures($bundle = '')
    {
    ...
    public function maintenanceOn()
    {
        ...
        return $this->drush('sset --exact system.maintenance_mode 1 --input-format=integer');
    }
    ...
    public function maintenanceOff()
    {
        ...
        return $this->drush('sset --exact system.maintenance_mode 0 --input-format=integer');
    }
     ...
     * @return $this
     */
    public function dropMysqlDatabase()
    {
        return $this->drush('sql-drop');
    }
     ...
     * @return $this
     */
    public function importMysqlDump($databasePath)
    {
        return $this->drush('sql-cli < ' . $databasePath);
    }
}
